  ...
  describe VisitorPattern::Shelf do
    ...
    context "when empty" do
      ...
      context "and items are added" do
        ...
        it "pops the most recently added item first" do
          first_item = spy('first_item')
          second_item = spy('second_item')
          empty_shelf.push first_item
          empty_shelf.push second_item

          expect(empty_shelf.pop).to equal second_item
          expect(empty_shelf.size).to eql 1
          expect(empty_shelf.face).to equal first_item
        end

        it "returns to empty after all items are popped" do
          first_item = spy('first_item')
          second_item = spy('second_item')
          empty_shelf.push first_item
          empty_shelf.push second_item
          ...
          expect(empty_shelf.pop).to equal second_item
          expect(empty_shelf.pop).to equal first_item
          expect(empty_shelf.size).to eql 0
          expect(empty_shelf.face).to equal nil
        end
      end
